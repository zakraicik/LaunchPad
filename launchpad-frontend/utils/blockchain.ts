...
import { ALCHEMY_SETTINGS } from "../config/blockchain";
import {
  getContractAddress,
  SUPPORTED_NETWORKS,
  CONTRACT_ADDRESSES,
...
export const getContractAddressForNetwork = (
  networkId: (typeof SUPPORTED_NETWORKS)[number],
  contract: keyof (typeof CONTRACT_ADDRESSES)[(typeof SUPPORTED_NETWORKS)[number]]
) => {
  return getContractAddress(networkId, contract);
};
