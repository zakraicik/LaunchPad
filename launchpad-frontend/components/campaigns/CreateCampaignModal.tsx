...
export default function CreateCampaignModal({
  ...
  return (
    ...
    >
      <div
        className="fixed inset-0 bg-white/10 backdrop-blur-md shadow-[0_0_10px_rgba(191,219,254,0.2)]"
        aria-hidden="true"
      />

      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-2xl w-full bg-white/10 rounded-xl shadow-xl flex flex-col max-h-[90vh] border border-gray-100">
          <Dialog.Title className="text-lg font-medium text-blue-600 p-6 border-b bg-white/10 rounded-t-xl">
            Create New Campaign
          </Dialog.Title>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full pl-4 pr-4 py-2.5 bg-white/30 border-2 border-gray-200 rounded-lg text-base font-medium focus:outline-none focus:ring-2 focus:ring-gray-100 focus:border-gray-400 transition-all"
                required
              />
            </div>
          ...
          <div className="flex justify-end space-x-3 p-6 border-t bg-white-10 rounded-b-xl">
            <button
              type="button"
              onClick={onClose}
