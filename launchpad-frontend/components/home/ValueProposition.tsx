    ...
    <section className="py-16 bg-white/0">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Not Just Crowdfunding</h2>
          <p className="text-xl text-gray-600">Our web3 Difference</p>
        </div>
        ...
        <GridContainer>
          {values.map((value, index) => (
            <div
              ...
              className="p-4 rounded-lg bg-white/10 backdrop-blur-md shadow-[0_0_10px_rgba(191,219,254,0.2)] hover:shadow-[0_0_15px_rgba(191,219,254,0.3)] border border-gray-100 transition-all duration-300 hover:scale-105 h-full flex flex-col cursor-pointer"
            >
